...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setGroupConfig(new GroupConfig("test3", "02070c55c6e846fca58950a97a90c1ef"));
        config.setProperty("hazelcast.client.statistics.enabled","true");
        config.setProperty(ClientProperty.HAZELCAST_CLOUD_DISCOVERY_TOKEN.getName(), "BtoDAF1Rg6q7x6iuh0dy0nto5opUXAzIpz08v1edQNhOlYUrYD");
